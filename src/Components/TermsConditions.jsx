...
export default function TermsConditions(){
    return(
        <div>
        <div className="flex flex-col p-10 text-justify relative w-full justify-center items-center text-center overflow-hidden mt-10">
            <h1 className="text-[28px] overflow-hidden">Terms & Conditions</h1>
Last updated on 25-01-2025 21:47:38
These Terms and Conditions, along with privacy policy or other terms “Terms” constitute a binding agreement by and between AAKARSH KUMAR,  “Website Owner” or “we” or “us” or “our” and you “you” or “your” and relate to your use of our website, goods as applicable or services as applicable collectively, “Services”.
...
All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Gaya, Bihar

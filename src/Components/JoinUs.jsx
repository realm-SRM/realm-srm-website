          ...
          <div>
            <div className="relative w-[300px] h-[500px] rounded-xl overflow-hidden bg-[#1b2243] border-2 border-[#F99D93] shadow-lg">
              ...
              <div className="flex mt-[300px] justify-center">
                <h2 className="mt-[-70px] text-[#FFDCC1] font-bold text-[20px]">Tap Here To Pay</h2>
                
              </div>
              <img className="w-[150px] ml-[30%] mt-[-5px]" src={TapPay} alt="Tap&Pay" onClick={ submitPayment } />
